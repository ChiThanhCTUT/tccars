...
$sql_cars = "SELECT * FROM cars WHERE is_available = 1 LIMIT 8";
...
<body>
  <header>
    <div class="container">
      <div class="logo"><a href="<?= $base ?>/app/views/trangchu.php">DV Thuê Xe KTPM</a></div>
      <nav>
         <ul>
            <li><a href="<?= $base ?>/app/views/trangchu.php">Trang chủ</a></li>
            <li><a href="<?= $base ?>/app/views/xe.php">Các loại xe</a></li>
            <li><a href="<?= $base ?>/app/views/gioithieu.html">Giới thiệu</a></li>
    ...
    <section class="hero">
      <div class="container">
        ...
        <!-- Các lợi ích khi thuê xe -->
    <section class="features">
      <div class="container">
        <h2>Vì sao nên chọn DV Thuê Xe KTPM?</h2>
        <div class="feature-list">
          <div class="feature-item">
            ...
            />
            <h3>Đa dạng xe</h3>
            <p>Từ phổ thông đến cao cấp, có tài xế hoặc tự lái.</p>
          </div>
          <div class="feature-item">
            <img
              src="https://img.icons8.com/ios/100/security-checked--v1.png"
              alt="secure icon"
            />
            <h3>An toàn & minh bạch</h3>
            <p>Thông tin rõ ràng, đánh giá người dùng xác thực.</p>
          </div>
          <div class="feature-item">
            <img
            ...
            />
            <h3>Tiện lợi</h3>
            <p>Đặt xe nhanh chóng, giao nhận xe tận nơi.</p>
          </div>
        </div>
      </div>
    </section>
            ...
            ?>
                <div class="car-item">
                    ...
                    <div class="car-item-content">
                        ...
                        <p class="price">Giá: <?php echo number_format($car['price_per_day']); ?> VNĐ/ngày</p>
                        
                        <div class="actions">
                            <a href="chitetxe.php?car_id=<?php echo $car['car_id']; ?>" class="btn view-details">Chi tiết</a>
                            <a href="booking.php?car_id=<?php echo $car['car_id']; ?>" class="btn book-now">Đặt ngay</a>
                        </div>
                    </div>
                </div>
            <?php
